...
> A 24-month, topic-by-topic execution plan with curated resources, exercises, and precise timelines — following a structured roadmap from foundational CS to production-grade distributed systems.

**Phase:** 01 of 08 | **Timeline:** 24 Months | **Status:** In Progress
...
| **02** | Databases: Beyond CRUD | Months 3-8 | Read EXPLAIN ANALYZE fluently, design schemas that scale |
| **03** | Distributed Systems Engineering | Months 6-14 | Design and debug distributed systems under failure |
| **04** | Production Engineering | Months 10-18 | Run systems reliably at scale, on-call ready |
| **05** | System Design as Craft | Months 12-20 | Lead architecture discussions, write ADRs |
| **06** | Language Mastery | Months 1-24 | Own one language at the runtime level |
| **07** | Security and Reliability Patterns | Months 16-22 | Threat model, design for zero-trust |
...
|
|-- phase-01-foundations/       # CPU, OS, Networking, Concurrency, Data Structures
...
|-- phase-06-language/          # Go runtime internals, Rust ownership and async
...
> Folders will be created as I progress through each phase.
...
**Anchor Book:** CS:APP (Bryant and O'Hallaron)

CS fundamentals that never expire — the same in 2025 as they were in 1985.

| # | Topic | Timeline | Status |
|:-:|-------|----------|:------:|
| 1.1 | How Computers Actually Work — CPU, Memory and Execution | Weeks 1-2 | Not Started |
| 1.2 | OS Internals — Processes, Threads and the Kernel | Weeks 2-4 | Not Started |
| 1.3 | Networking from First Principles — TCP/IP, TLS, HTTP | Weeks 3-5 | Not Started |
| 1.4 | Concurrency Theory — The Hardest Fundamental | Weeks 4-7 | Not Started |
| 1.5 | Data Structures: The Right Depth | Weeks 6-8 | Not Started |
...
## Phase 02 — Databases: Beyond CRUD

**Duration:** Months 3-8 (20 weeks)

**Anchor Books:** DDIA (Kleppmann) + Database Internals (Petrov)

Go 10x deeper than anyone around you. The database is where every serious backend problem lives.

| # | Topic | Timeline | Status |
|:-:|-------|----------|:------:|
| 2.1 | Query Execution Internals | Weeks 1-3 | Not Started |
| 2.2 | Indexing Mastery | Weeks 2-5 | Not Started |
| 2.3 | Transactions, MVCC and Isolation Levels | Weeks 4-7 | Not Started |
| 2.4 | Distributed Databases, Redis Internals and CDC | Weeks 8-14 | Not Started |
...
**Anchor Book:** DDIA (Kleppmann) — second read

Where backend engineering becomes truly hard. Most engineers never get here.

| # | Topic | Timeline | Status |
|:-:|-------|----------|:------:|
| 3.1 | Distributed Systems Fundamentals — Failure Models | Weeks 1-3 | Not Started |
| 3.2 | Consensus Algorithms — Raft and Paxos | Weeks 3-6 | Not Started |
| 3.3 | Kafka Deeply — Beyond Produce and Consume | Weeks 5-9 | Not Started |
| 3.4 | Idempotency, Sagas and Distributed Correctness | Weeks 9-14 | Not Started |
...
- Stripe Blog on Idempotency Keys — [stripe.com/blog/idempotency](https://stripe.com/blog/idempotency)
...
**Anchor Book:** Google SRE Book (free online)

Code that works on your machine is the beginning. Code that works at 3am is the craft.

| # | Topic | Timeline | Status |
|:-:|-------|----------|:------:|
| 4.1 | Observability — Philosophy and Practice | Weeks 1-4 | Not Started |
| 4.2 | Performance Profiling and Debugging | Weeks 4-8 | Not Started |
| 4.3 | SLOs, Error Budgets and Reliability Engineering | Weeks 6-10 | Not Started |
| 4.4 | Chaos Engineering and Zero-Downtime Deployments | Weeks 10-18 | Not Started |
...
## Phase 05 — System Design as Craft

**Duration:** Months 12-20

**Anchor Book:** Software Architecture: The Hard Parts

The synthesis of everything. Where all deep knowledge creates real leverage.

| # | Topic | Timeline | Status |
|:-:|-------|----------|:------:|
| 5.1 | API Design as a Contract | Weeks 1-4 | Not Started |
| 5.2 | Rate Limiting, Backpressure and Flow Control | Weeks 3-6 | Not Started |
| 5.3 | Back-of-Envelope Estimation | Weeks 5-8 | Not Started |
...
**Duration:** Months 1-24 (parallel track)

**Primary Language:** Go | **Secondary:** Rust

Go deep in one language. Know its runtime, memory model, and failure modes completely.

| # | Topic | Timeline | Status |
|:-:|-------|----------|:------:|
| 6.1 | Go Runtime Internals (GMP Scheduler, GC, Channels) | Months 1-12 | Not Started |
| 6.2 | Rust — Memory Safety Without GC | Months 6-18 | Not Started |
...
## Phase 07 — Security and Reliability Patterns

**Duration:** Months 16-22

**Anchor Resource:** OWASP Top 10 + Web Application Security (O'Reilly)

Threat model first. Build security into the architecture, not as an afterthought.

| # | Topic | Timeline | Status |
|:-:|-------|----------|:------:|
| 7.1 | Authentication and Authorization Deeply | Weeks 1-6 | Not Started |
| 7.2 | Injection Attacks, Secrets Management and Defense in Depth | Weeks 4-10 | Not Started |
...
What separates the top 1% is not just what they know — it is how they operate every day.

| # | Topic | Cadence | Status |
|:-:|-------|---------|:------:|
| 8.1 | Source Code Reading as a Discipline | 1 hr/week minimum | Not Started |
| 8.2 | Writing to Think and to Lead | 2 posts/month minimum | Not Started |
| 8.3 | Study Real Systems — Engineering Blogs | 2 hrs/week | Not Started |
...
1. **Notes and Summaries** — Written explanations of every concept in my own words
...
| Book | Author | Phases |
|------|--------|--------|
| Computer Systems: A Programmer's Perspective (CS:APP) | Bryant and O'Hallaron | 01 |
...
| The Go Programming Language | Donovan and Kernighan | 06 |
| The Rust Programming Language | Klabnik and Nichols | 06 |
